 ...
 *
*/
#include "ss_dsi_smart_dimming_S6E3HA0_AMS510CW01.h"
...
static void gamma_init_revL(struct SMART_DIM *pSmart, char *str, int size)
{
	...
	for (cnt = 1; cnt < TABLE_MAX; cnt++) {
		...
		bl_index[TABLE_MAX - cnt] += gradation_offset_revL[table_index][cnt - 1];
